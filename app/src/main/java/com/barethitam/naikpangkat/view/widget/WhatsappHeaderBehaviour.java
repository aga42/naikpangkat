 ...
 */
public class WhatsappHeaderBehaviour extends CoordinatorLayout.Behavior<HeaderView> {
    ...
    public WhatsappHeaderBehaviour(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
    }

    public WhatsappHeaderBehaviour(Context context, AttributeSet attrs, Context mContext) {
        super(context, attrs);
